...
export class Currencies
{
    private static currencies = [
        ...
        { iso: "AUD", name: "Australian dollar", format: "", decimals: 2 },
        ...
        { iso: "CNY", name: "Renminbi", format: "", decimals: 2 },
        ...
        { iso: "DKK", name: "Danish krone", format: "* kr", decimals: 2 },
        ...
        { iso: "HKD", name: "Hong Kong dollar", format: "", decimals: 2 },
        ...
        { iso: "JPY", name: "Japanese yen", format: "", decimals: 0 },
        ...
        { iso: "NOK", name: "Norwegian krone", format: "", decimals: 2 },
        { iso: "NPR", name: "Nepalese rupee", format: "", decimals: 2 },
        { iso: "NZD", name: "New Zealand dollar", format: "", decimals: 2 },
        ...
        { iso: "SEK", name: "Swedish krona (plural: kronor)", format: "", decimals: 2 },
    ...
    public static formatAmount(amount: number | string, iso: string)
    {
        ...
        const format = currency?.format || `* ${iso}`;
        return format.split("*").join(Currencies.parse(amount, iso).toString());
    }
