...
export class RemoteRoomController
{
    ...
    public async joinRoom(host: string, roomKey: string, onStatusChange: OnStatusChange)
    {
        await onStatusChange("Fetching local room directory...");
        ...
        await onStatusChange("Saving local room directory...");
    ...
    public async getRoomFull(info: RoomInfo, onStatusChange: OnStatusChange): Promise<{ room: RoomRoot, users: RoomUserData[] } | null>
    {
    ...
    public async getRoomUserData(info: RoomInfo, root: RoomRoot, onStatusChange: OnStatusChange)
    {
        ...
        await onStatusChange("Checking connection...");
        ...
        await onStatusChange("Fetching user data...");
        const users = Object.values((await remote.getAsGuest(userKeys, root.guestToken)) ?? {}) as RoomUserData[];
        return users;
    }
    public async getRoomRoot(info: RoomInfo, onStatusChange: OnStatusChange)
    {
        ...
        await onStatusChange("Fetching room data...");
